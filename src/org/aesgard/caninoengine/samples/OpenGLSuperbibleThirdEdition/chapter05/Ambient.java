...
public class Ambient extends CaninoGameEngine3D {
	@Override
	public void RenderScene() {
		...
		glBegin(GL_TRIANGLES);
            ...
            // Body of the Plane ////////////////////////
            // light gray
            glColor3ub((byte)192,(byte)192,(byte)192);
            glVertex3f(-15.0f,0.0f,30.0f);
            glVertex3f(0.0f, 15.0f, 30.0f);
            ...
            // Left wing
            // Dark gray
            glColor3ub((byte)64,(byte)64,(byte)64);
	...
	public void SetupRC() {
	    ...
	    glLightModel(GL_LIGHT_MODEL_AMBIENT,array2FloatBuffer(ambientLight));
