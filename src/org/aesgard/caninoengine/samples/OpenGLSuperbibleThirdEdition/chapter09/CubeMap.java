...
public class CubeMap extends CaninoGameEngine3D {
	...
	private int CUBE_MAP = 2;
	private int NUM_TEXTURES = 3;

	private int[] textureObjects = new int[NUM_TEXTURES];

	private String[] szTextureFiles = { "res/grass.tga", "res/orb.tga",
			"res/down.tga" };

	private String[] szCubeFaces = { "res/right.tga", "res/left.tga",
			"res/up.tga", "res/down.tga", "res/backward.tga", "res/forward.tga" };
