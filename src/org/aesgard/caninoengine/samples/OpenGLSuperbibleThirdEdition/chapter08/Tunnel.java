...
public class Tunnel extends CaninoGameEngine3D {
	...
	private String[] szTextureFiles = new String[]{ "res/brick.tga", "res/floor.tga", "res/ceiling.tga" };
	...
	public void SetupRC() {
	    ...
	    for(iLoop = 0; iLoop < TEXTURE_COUNT; iLoop++)
	    {
	        ...
	        gluBuild2DMipmaps(GL_TEXTURE_2D, GL_RGB8, texture.getWidth(), texture.getHeight(), GL_BGR_EXT, GL_UNSIGNED_BYTE, texture.getByteBuffer());
