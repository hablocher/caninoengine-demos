...
public class SphereWorld extends CaninoGameEngine3D {
	...
	private final static int GROUND_TEXTURE = 0;
	private final static int TORUS_TEXTURE = 1;
	private final static int SPHERE_TEXTURE = 2;
	private final static int NUM_TEXTURES = 3;
	private int[] textureObjects = new int[NUM_TEXTURES];

	private TextureLoader loader = new TextureLoader();

	private String[] szTextureFile = { "res/grass.tga", "res/wood.tga", "res/orb.tga" };
	...
	public void SetupRC() {
		...
		for (i = 0; i < NUM_TEXTURES; i++) {
			...
			Texture texture = loader.Load(ImageType.TGA, szTextureFile[i]);
	...
	public void ShutdownRC() {
		// Delete the textures
		glDeleteTextures(array2IntBuffer(textureObjects));
	}
